//+============================================================================
//
// file :               TemplCommandInOut.java
//
// description :        Java source code for the TemplCommandInOut class. This class
//			is a class derived from the Command class. It is used
//			to implement command with the template command method.
//			This class is for commands with input and output
//			parameters.
//
// project :            TANGO
//
...
public class TemplCommandInOut extends TemplCommand implements TangoConst
{

//+-------------------------------------------------------------------------
//
// method : 		TemplCommandInOut 
// 
 ...
 */
	...
	public TemplCommandInOut(String name,String exe_method,
				 String state_method,DispLevel disp)
	{
		super(name,disp);
 ...
 * also set the command input and output type to the correct value depending on the
 * execution method input and output parameter type
 *
...
//
			...
			if (meth_list.length == 0)
			{
				...
				Except.throw_exception("API_MethodNotFound",
						     mess.toString(),
				  	  	     "TemplCommandInOut.analyse_method_exe()");
			}
...
//
			...
			case Tango_DEV_BOOLEAN:
				meth_param[0] = extract_DevBoolean(in_any);
				break;
				
			case Tango_DEV_SHORT:
				meth_param[0] = extract_DevShort(in_any);
				break;
				
			case Tango_DEV_LONG:
				meth_param[0] = extract_DevLong(in_any);
				break;
				
			case Tango_DEV_LONG64:
				meth_param[0] = extract_DevLong64(in_any);
				break;
				
			case Tango_DEV_FLOAT:
				meth_param[0] = extract_DevFloat(in_any);
				break;
				
			case Tango_DEV_DOUBLE:
				meth_param[0] = extract_DevDouble(in_any);
				break;
