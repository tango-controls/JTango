 ...
 * @author  ounsy
 */
public class TangoPeriodicEvent extends EventObject implements java.io.Serializable{
    
    /** Creates a new instance of AttrPeriodicChangeEvent */
    public TangoPeriodicEvent(TangoPeriodic source, EventData event_data)
    {
        super(source);
