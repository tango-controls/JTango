...
JTango provides fat jar file one can download from the bintray repo (aka JTango-9.4.1.jar). This jar includes all required class files so just add it to your class path.
