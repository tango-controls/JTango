...
//
// $Log$
// Revision 1.4  2009/01/13 10:56:47  viguier
// Update to TangoORB 7
//
// Revision 1.3  2008/09/04 13:35:00  viguier
// add comment
//
// Revision 1.2  2008/09/04 13:31:33  viguier
// add method: insert_uc(byte[] argin)
//
...
public class DeviceAttributeDAOWebImpl implements IDeviceAttributeDAO, IWebImpl {
	...
	*/
	...
	//TODO Remove comment for TANGO 7
	/*
	public void insert(DevEncoded arg0) {
		try {
			WebServerClientUtil.getResponse(this, classParam, "insert", new Object[] {arg0 }, new Class[] { DevEncoded.class });
	...
	*/
	...
	public AttributeValue_4 getAttributeValueObject_4() {
		try {
			return (AttributeValue_4) WebServerClientUtil.getResponse(this, classParam, "getAttributeValueObject_4", new Object[] {}, new Class[] {});
