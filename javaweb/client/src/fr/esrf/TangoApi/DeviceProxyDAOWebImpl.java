...
//
// $Log$
// Revision 1.5  2009/01/13 10:56:47  viguier
// Update to TangoORB 7
//
// Revision 1.4  2008/05/21 08:20:42  soleilarc
// version of webtanorg compatible with TangORB 6.0.2
//
// Revision 1.3  2008/02/18 15:16:03  ounsy
...
public class DeviceProxyDAOWebImpl extends ConnectionDAOWebImpl implements IDeviceProxyDAO, ApiDefs, IWebImpl {
	 ...
	 */
	//==========================================================================
	public DeviceAttribute[] write_read_attribute(DeviceProxy arg0,
			DeviceAttribute[] devattr) throws DevFailed {
	...
	{
		return (LockerInfo) WebServerClientUtil.getResponse(this, classParam, "getLockerInfo", new Object[] {}, new Class[] {});
	}
	*/
	// ==========================================================================
	// ==========================================================================
	...
	public int subscribe_event(DeviceProxy deviceProxy, String attr_name,
			int event, CallBack callback, String[] filters, boolean stateless)
			throws DevFailed {
		System.out.println("First version of TANGO WEB No event manage");
		DevError error = new DevError();
		throw new DevFailed(new DevError[]{error});
	...
	public int subscribe_event(DeviceProxy arg0, String arg1, int arg2,
			int arg3, String[] arg4, boolean arg5) throws DevFailed {
		System.out.println("First version of TANGO WEB No event manage");
		DevError error = new DevError();
		throw new DevFailed(new DevError[]{error});
	}
