...
public class ProcessAction
{
	...
	private WebResponse processAction(String application, String className, Object[] aClassParam, String methodName, Object[] aParameter, Class[] aParameterClass) throws Exception
	{
	    try {
	    	...
	    	System.err.println("processAction : " + className);
	        System.err.println("Class.forName(  ) can't find the class");
	        throw e;
	      } catch (NoSuchMethodException e2) {
	    	System.err.println("processAction : " + className);
	    	System.err.println("method doesn't exist");
	        System.err.println("className :" + className + ": methodName :" + methodName);
	        throw e2;
	      } catch (IllegalAccessException e3) {
	    	System.err.println("processAction : " + className);
	        System.err.println("no permission to invoke that method");
	        throw e3;
	      } catch (InvocationTargetException e) {
	    	System.err.println("processAction : " + className);
	        System.err.println("an exception ocurred while invoking that method");
	...
	private Object createClass(String application, String className, Object[] aClassParam) throws Exception
	{
	    ...
	    try {
	    	...
	    	System.err.println("WebApplicationConfig.getSingleton().getRules().getDestClass(className); in : '" + className+"'");	    	  
	    	System.err.println("WebApplicationConfig.getSingleton().getRules().getDestClass(className); out : '" + tempStrClass+"'");
	    	System.err.println("Class.forName(  ) can't find the class");
	        throw e;
	      } catch (NoSuchMethodException e2) {
		    	System.err.println("WebApplicationConfig.getSingleton().getRules().getDestClass(className); in : '" + className+"'");	    	  
	...
	private WebResponse processMethod(String application, Object object, String methodName, Object[] aParameter, boolean bIsSaved, Class[] aParameterClass) throws Exception
	{
	    ...
	    }catch (NullPointerException nulle)
	    {
	        ...
	        System.err.println("an exception ocurred while invoking that method");
	        // String application, Object object, String methodName, Object[] aParameter, boolean bIsSaved, Class[] aParameterClass
	        
	        if(object != null && object.getClass() != null)
	        	System.err.println("Class Name :" + object.getClass().getName());
	        System.err.print("Object Name :" + object + " : ");
	        System.err.print("Method Name :" + methodName + " : ");
	        if(aParameter != null)
	        	System.err.print("Object[] length :" + aParameter.length + " : ");
	        System.err.print("bIsSaved :" + bIsSaved + " : ");
	        ...
	        {
	        	if(param != null)
	        		System.err.print( param.getClass() + ", ");
	        }
	        System.err.println();
