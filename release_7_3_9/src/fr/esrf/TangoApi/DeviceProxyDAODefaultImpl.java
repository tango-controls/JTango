...
//
// $Log$
// Revision 1.30  2010/12/17 13:05:35  pascal_verdier
// In case of READ_ONLY mode, throw exception with user and host name.
//
// Revision 1.29  2010/09/10 09:38:12  abeilleg
...
public class DeviceProxyDAODefaultImpl extends ConnectionDAODefaultImpl implements ApiDefs,
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
        ...
        throwNotAuthorizedException(deviceProxy.devname + ".set_attribute_info()",
