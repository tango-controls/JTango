	...
	implements fr.esrf.Tango.Device_4
{
	...
	public fr.esrf.Tango.AttributeValue_4[] write_read_attributes_4(fr.esrf.Tango.AttributeValue_4[] values, fr.esrf.Tango.ClntIdent cl_ident) throws fr.esrf.Tango.MultiDevFailed,fr.esrf.Tango.DevFailed
	{
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			Device_4Operations _localServant = (Device_4Operations)_so.servant;
			fr.esrf.Tango.AttributeValue_4[] _result;			try
			{
	...
	public fr.esrf.Tango.DevAttrHistory_4 read_attribute_history_4(java.lang.String name, int n) throws fr.esrf.Tango.DevFailed
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "read_attribute_history_4", true);
				_os.write_string(name);
				_os.write_long(n);
				_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			Device_4Operations _localServant = (Device_4Operations)_so.servant;
			fr.esrf.Tango.DevAttrHistory_4 _result;			try
			{
	...
	public fr.esrf.Tango.DevCmdHistory_4 command_inout_history_4(java.lang.String command, int n) throws fr.esrf.Tango.DevFailed
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "command_inout_history_4", true);
				_os.write_string(command);
				_os.write_long(n);
				_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			Device_4Operations _localServant = (Device_4Operations)_so.servant;
			fr.esrf.Tango.DevCmdHistory_4 _result;			try
			{
	...
	public fr.esrf.Tango.AttributeValue_4[] read_attributes_4(java.lang.String[] names, fr.esrf.Tango.DevSource source, fr.esrf.Tango.ClntIdent cl_ident) throws fr.esrf.Tango.DevFailed
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "read_attributes_4", true);
				fr.esrf.Tango.DevVarStringArrayHelper.write(_os,names);
				fr.esrf.Tango.DevSourceHelper.write(_os,source);
				fr.esrf.Tango.ClntIdentHelper.write(_os,cl_ident);
				_is = _invoke(_os);
	...
	public org.omg.CORBA.Any command_inout_4(java.lang.String command, org.omg.CORBA.Any argin, fr.esrf.Tango.DevSource source, fr.esrf.Tango.ClntIdent cl_ident) throws fr.esrf.Tango.DevFailed
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "command_inout_4", true);
				_os.write_string(command);
				_os.write_any(argin);
				fr.esrf.Tango.DevSourceHelper.write(_os,source);
				fr.esrf.Tango.ClntIdentHelper.write(_os,cl_ident);
