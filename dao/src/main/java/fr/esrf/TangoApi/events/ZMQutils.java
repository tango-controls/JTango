...
public class ZMQutils {
    ...
    private static String getString(byte[] bytes, int start) throws DevFailed {
        ...
        if (length <= 0)
            throw DevFailedUtils.newDevFailed("API_BadSyntax",
     ...
     */
    private static String getFullAttributeName(String tangoHost, String deviceName, String attributeName,
    ...
    private static byte[] getBufferToDisConnectEvent(String tangoHost, String deviceName,
        ...
        try {
            ...
            throw DevFailedUtils.newDevFailed("API_ConversionFailed", e.getMessage(), e);
        }
        return buffer;
    }
    ...
    static void connectEvent(String tgHost, String deviceName, String attributeName,
        ...
        if (tangoHosts != null) {
            ...
            DevFailedUtils.throwDevFailed("Api_NoTangoHost", "No TANGO_HOST defined");
    }
    ...
    private static byte[] getBufferToConnectHeartbeat(String tangoHost,
                                                      String adminDeviceName, DevVarLongStringArray lsa, boolean forceConnect) {
        byte[] buffer = new byte[0];
        ArrayList<String> stringList = new ArrayList<String>();
    ...
    static DevError[] deMarshallErrorList(byte[] recData, boolean littleIndian) throws DevFailed {
        try {
            ...
            throw DevFailedUtils.newDevFailed(
                    "Api_ConversionFailed", "An exception " + e.getClass().getSimpleName() + " has been catch", e);
        }
    }
    ...
    static ZmqCallInfo deMarshallZmqCallInfo(byte[] recData, boolean littleIndian) throws DevFailed {
        try {
            ...
            throw DevFailedUtils.newDevFailed("Api_ConversionFailed", "An exception " + e.getClass().getSimpleName() + " has been catch", e);
        }
    }
    ...
    static DeviceInterface deMarshallAttInterfaceChange(byte[] recData, boolean littleIndian) throws DevFailed {
        try {
            ...
            throw DevFailedUtils.newDevFailed("Api_ConversionFailed",
                    "An exception " + e.getClass().getSimpleName() + " has been catch", e);
        }
    }
    ...
    static DeviceAttribute deMarshallAttribute(byte[] recData, boolean littleIndian, int idl) throws DevFailed {
        try {
            ...
            //  Check device IDL
            if (idl < 4) {
                throw DevFailedUtils.newDevFailed("SeverTooOld",
    ...
    static int getEventType(String eventName) throws DevFailed {
        ...
        if (type < 0)
            throw DevFailedUtils.newDevFailed("Api_BadParameterException",
