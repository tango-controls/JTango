...
//
// $Log$
// Revision 1.27  2010/08/11 10:06:26  abeilleg
// asynchronous API: add MultiDevFailed management for IDL 4 servers.
//
// Revision 1.26  2010/08/06 13:54:45  abeilleg
// memory leak fix for jacorb objects(ReplyReceiver) when server is in timeout.
//
// Revision 1.25  2010/08/05 13:08:37  abeilleg
// bug fix: build_connection was always called for devices that are IDL2,3,4.
//
// Revision 1.24  2010/07/29 11:57:48  abeilleg
// bug fix: reconnection was not done on asynchronous API.
//
// Revision 1.23  2010/07/27 14:43:34  abeilleg
// replace check on string org.omg.CORBA.CORBA by org.omg.CORBA
//
// Revision 1.22  2010/05/31 12:54:43  abeilleg
// make the projet compile with maven.
//
// Revision 1.21  2010/03/31 09:18:46  pascal_verdier
// Add a toLowerCase() on polled objects.
//
// Revision 1.20  2009/10/08 11:44:02  pascal_verdier
// Memory leak removed and wait replace by Thread.sleep (Gwenaelle Abeille)
//
// Revision 1.19  2009/05/06 14:21:59  pascal_verdier
// Traces removed on time measurement for attribute history.
//
// Revision 1.18  2009/03/31 07:52:35  pascal_verdier
// Ident added for asynchronous calls
//
// Revision 1.17  2009/03/25 13:32:08  pascal_verdier
// ...
//
...
public class DeviceProxyDAODefaultImpl extends ConnectionDAODefaultImpl implements ApiDefs,
     ...
     */
    // ===========================================================
    public CommandInfo command_query(final DeviceProxy deviceProxy, final String cmdname)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public void export_device(final DeviceProxy deviceProxy, final DbDevExportInfo devinfo)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public String[] get_property_list(final DeviceProxy deviceProxy, final String wildcard)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public DbDatum get_property(final DeviceProxy deviceProxy, final String propname)
	    throws DevFailed {
	if (deviceProxy.url.protocol == TANGO) {
	    checkIfUseDb(deviceProxy, "get_property()");
     ...
     */
    // ==========================================================================
    public DbDatum[] get_property(final DeviceProxy deviceProxy, final DbDatum[] properties)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "get_property()");
     ...
     */
    // ==========================================================================
    public void put_property(final DeviceProxy deviceProxy, final DbDatum[] properties)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "put_property()");
     ...
     */
    // ==========================================================================
    public void delete_property(final DeviceProxy deviceProxy, final String[] propnames)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public void delete_property(final DeviceProxy deviceProxy, final String propname)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "delete_property()");
     ...
     */
    // ==========================================================================
    public void delete_property(final DeviceProxy deviceProxy, final DbDatum[] properties)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "delete_property()");
     ...
     */
    // ==========================================================================
    public void put_attribute_property(final DeviceProxy deviceProxy, final DbAttribute[] attr)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public void delete_attribute_property(final DeviceProxy deviceProxy, final String attname,
    ...
    // ==========================================================================
    public void delete_attribute_property(final DeviceProxy deviceProxy, final String attname,
	    final String propname) throws DevFailed {
	checkIfUseDb(deviceProxy, "delete_attribute_property()");
     ...
     * 
     * @param attr
     *            DbAttribute objects specifying attributes.
     */
    // ==========================================================================
    public void delete_attribute_property(final DeviceProxy deviceProxy, final DbAttribute attr)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "delete_attribute_property()");
     ...
     * 
     * @param attr
     *            DbAttribute objects array specifying attributes.
     */
    // ==========================================================================
    public void delete_attribute_property(final DeviceProxy deviceProxy, final DbAttribute[] attr)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public DbAttribute get_attribute_property(final DeviceProxy deviceProxy, final String attname)
	    throws DevFailed {
	checkIfUseDb(deviceProxy, "get_attribute_property()");
     ...
     */
    // ==========================================================================
    public void delete_attribute(final DeviceProxy deviceProxy, final String attname)
	    throws DevFailed {
     ...
     */
    // ==========================================================================
    public AttributeInfo[] get_attribute_info(final DeviceProxy deviceProxy, final String[] attnames)
	    throws DevFailed {
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
	    ...
	    Except.throw_connection_failed("TangoApi_READ_ONLY_MODE", deviceProxy.devname
		    + ".set_attribute_info()  is not authorized !",
	...
	try {
		...
		deviceProxy.device_4.set_attribute_config_4(config, DevLockManager.getInstance()
			.getClntIdent());
     ...
     */
    // ==========================================================================
    public DeviceAttribute[] read_attribute(final DeviceProxy deviceProxy, final String[] attnames)
	    throws DevFailed {
	...
	if (deviceProxy.url.protocol == TANGO) {
		...
		try {
		    if (deviceProxy.device_4 != null) {
			attrval_4 = deviceProxy.device_4.read_attributes_4(attnames,
				deviceProxy.dev_src, DevLockManager.getInstance().getClntIdent());
		    } else if (deviceProxy.device_3 != null) {
			attrval_3 = deviceProxy.device_3.read_attributes_3(attnames,
				deviceProxy.dev_src);
		    } else if (deviceProxy.device_2 != null) {
			attrval = deviceProxy.device_2.read_attributes_2(attnames,
				deviceProxy.dev_src);
		    } else {
		    ...
		    Except.throw_connection_failed(e, "TangoApi_CANNOT_READ_ATTRIBUTE",
			    "Cannot read attribute(s):   " + sb.toString(), deviceProxy
				    .getFull_class_name()
				    + ".read_attribute()");
		} catch (final Exception e) {
		    System.out.println("read_attribute catch Exception");
		    e.printStackTrace();
		    manageExceptionReconnection(deviceProxy, retries, i, e, this.getClass()
			    + ".read_attribute");
		}
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
	    ...
	    Except.throw_connection_failed("TangoApi_READ_ONLY_MODE", deviceProxy.devname
		    + ".write_attribute()  is not authorized !", "DeviceProxy.write_attribute()");
	}
	...
	for (int i = 0; i < retries && !done; i++) {
	    ...
	    try {
		if (deviceProxy.device_4 != null) {
		    deviceProxy.device_4.write_attributes_4(attrval_4, DevLockManager.getInstance()
			    .getClntIdent());
		} else if (deviceProxy.device_3 != null) {
		...
		throw new NamedDevFailedList(e, name(deviceProxy), "DeviceProxy.write_attribute",
			"MultiDevFailed");
	    } catch (final Exception e) {
		manageExceptionReconnection(deviceProxy, retries, i, e, this.getClass()
    ...
    public DeviceAttribute[] write_read_attribute(final DeviceProxy deviceProxy,
	    final DeviceAttribute[] devattr) throws DevFailed {
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
	    ...
	    Except.throw_connection_failed("TangoApi_READ_ONLY_MODE", deviceProxy.devname
		    + ".write_read_attribute()  is not authorized !",
	...
	for (int i = 0; i < retries && !done; i++) {
	    ...
	    try {
		if (deviceProxy.device_4 != null) {
		    out_attrval_4 = deviceProxy.device_4.write_read_attributes_4(in_attrval_4,
     ...
     */
    // ==========================================================================
    private void poll_object(final DeviceProxy deviceProxy, final String objname,
	    final String objtype, final int period) throws DevFailed {
	...
	try {
	    ...
	    Except.throw_communication_failed(e, "TangoApi_CANNOT_POLL_OBJECT",
		    "Cannot poll object " + objname, deviceProxy.getFull_class_name()
			    + ".poll_object()");
	}
    }
	...
	try {
	    ...
	    if (deviceProxy.device_4 != null) {
		final DevCmdHistory_4 cmd_histo = deviceProxy.device_4.command_inout_history_4(
			cmdname, nb);
		histo = ConversionUtil.histo4ToDeviceDataHistoryArray(cmdname, cmd_histo);
	    } else {
		final DevCmdHistory[] cmd_histo = deviceProxy.device_2.command_inout_history_2(
			cmdname, nb);
    ...
    public DeviceDataHistory[] attribute_history(final DeviceProxy deviceProxy,
	    final String attname, final int nb) throws DevFailed {
	...
	try {
	    // Check IDL revision to know kind of history.
	    if (deviceProxy.device_4 != null) {
		final DevAttrHistory_4 att_histo = deviceProxy.device_4.read_attribute_history_4(
			attname, nb);
		histo = ConversionUtil.histo4ToDeviceDataHistoryArray(att_histo);
	    } else if (deviceProxy.device_3 != null) {
		final DevAttrHistory_3[] att_histo = deviceProxy.device_3.read_attribute_history_3(
			attname, nb);
		...
		final DevAttrHistory[] att_histo = deviceProxy.device_2.read_attribute_history_2(
			attname, nb);
		histo = new DeviceDataHistory[att_histo.length];
		for (int i = 0; i < att_histo.length; i++) {
		    histo[i] = new DeviceDataHistory(att_histo[i]);
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
		...
		Except.throw_connection_failed("TangoApi_READ_ONLY_MODE", deviceProxy.devname
			+ ".command_inout_asynch(" + cmdname + ")  is not authorized !",
	...
	for (int i = 0; i < retries && !done; i++) {
		...
		if (forget) {
		    ...
		    names[0] = cmdname;
		    id = ApiUtil.put_async_request(new AsyncCallObject(request, deviceProxy, CMD,
			    names));
		}
		done = true;
	    } catch (final Exception e) {
    ...
    public DeviceData command_inout_reply(final DeviceProxy deviceProxy, final int id,
	    final int timeout) throws DevFailed, AsynReplyNotArrived {
     ...
     */
    // ==========================================================================
    public DeviceData command_inout_reply(final DeviceProxy deviceProxy, final AsyncCallObject aco,
	    final int timeout) throws DevFailed, AsynReplyNotArrived {
	...
	if (deviceProxy.device_4 != null) {
	    ...
	    setRequestArgsForReadAttr(request, attnames, get_source(deviceProxy), DevLockManager
		    .getInstance().getClntIdent(), AttributeValueList_4Helper.type());
	    ...
	    setRequestArgsForReadAttr(request, attnames, null, null, AttributeValueListHelper
		    .type());
	}
	...
	// store request reference to read reply later
	return ApiUtil
		.put_async_request(new AsyncCallObject(request, deviceProxy, ATT_R, attnames));
    }
	...
	try {
		...
		return args.item(0).value().extract_string(); // get command
		// name
	    } else {
    ...
    public void check_asynch_reply(final DeviceProxy deviceProxy, final Request request,
	    final int id, final String idl_cmd) throws DevFailed, AsynReplyNotArrived {
	...
	if (request == null) {
		...
		if (except != null) {
			...
			System.out.println(deviceProxy.getFull_class_name() + "." + idl_cmd
     ...
     */
    // ==========================================================================
    public DeviceAttribute[] read_attribute_reply(final DeviceProxy deviceProxy, final int id,
	    final int timeout) throws DevFailed, AsynReplyNotArrived {
	...
	if (deviceProxy.access == TangoConst.ACCESS_READ) {
	    ...
	    Except.throw_connection_failed("TangoApi_READ_ONLY_MODE", deviceProxy.devname
		    + ".write_attribute_asynch()  is not authorized !",
	...
	while ((t1 - t0 < timeout || timeout == 0) && !done) {
		...
		// GA t1 = System.currentTimeMillis();
		// System.out.println(" " + (t1-t0) + " ms");
	    } catch (final DevFailed e) {
		throw e;
	    }
     ...
     *            event callback.
     * @param stateless
     *            If true, do not throw exception if connection failed.
     */
    // ==========================================================================
    public int subscribe_event(final DeviceProxy deviceProxy, final String attr_name,
	...
	try {
	    final IEventConsumer event_consumer = ApiUtil.get_event_consumer();
	    id = event_consumer.subscribe_event(deviceProxy, attr_name.toLowerCase(), event,
		    callback, filters, stateless);
	} catch (final DevFailed e) {
	    throw e;
	} catch (final Exception e) {
	    e.printStackTrace();
	    Except.throw_communication_failed(e.toString(), "Subsrcibe event on "
		    + name(deviceProxy) + "/" + attr_name + " Failed !",
    ...
    // ==========================================================================
    public int subscribe_event(final DeviceProxy deviceProxy, final String attr_name,
	    final int event, final int max_size, final String[] filters, final boolean stateless)
	    throws DevFailed {
	int id = 0;
	if (ApiUtil.get_event_consumer() == null) {
	    ApiUtil.create_event_consumer();
     ...
     */
    // ==========================================================================
    public void unsubscribe_event(final DeviceProxy deviceProxy, final int event_id)
	    throws DevFailed {
	if (ApiUtil.get_event_consumer() == null) {
	    ApiUtil.create_event_consumer();
	}
	...
	try {
		...
		for (int i = 0; i < dev.length; i++) {
		    try {
			System.out
				.println(devnames[i] + " is " + ApiUtil.stateName(dev[i].state()));
			/*
