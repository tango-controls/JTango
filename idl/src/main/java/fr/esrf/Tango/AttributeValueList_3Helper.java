...
public abstract class AttributeValueList_3Helper
{
	...
	public static fr.esrf.Tango.AttributeValue_3[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new fr.esrf.Tango.AttributeValue_3[_l_result22];
