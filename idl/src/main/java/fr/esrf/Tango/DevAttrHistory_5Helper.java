...
public final class DevAttrHistory_5Helper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final fr.esrf.Tango.DevAttrHistory_5 s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static fr.esrf.Tango.DevAttrHistory_5 extract (final org.omg.CORBA.Any any)
	{
	...
	public static fr.esrf.Tango.DevAttrHistory_5 read (final org.omg.CORBA.portable.InputStream in)
	{
		fr.esrf.Tango.DevAttrHistory_5 result = new fr.esrf.Tango.DevAttrHistory_5();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final fr.esrf.Tango.DevAttrHistory_5 s)
	{
		java.lang.String tmpResult86 = s.name;
