...
public final class AttributeValue_5Helper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final fr.esrf.Tango.AttributeValue_5 s)
	{
		any.type(type());
	...
	public static fr.esrf.Tango.AttributeValue_5 read (final org.omg.CORBA.portable.InputStream in)
	{
		fr.esrf.Tango.AttributeValue_5 result = new fr.esrf.Tango.AttributeValue_5();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final fr.esrf.Tango.AttributeValue_5 s)
	{
		...
		java.lang.String tmpResult41 = s.name;
