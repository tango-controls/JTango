...
//
		...
		command_list.addElement(new StatusCmd(new String("Status"),Tango_DEV_VOID,Tango_DEV_STRING,new String("Device status")));
		command_list.addElement(new StateCmd(new String("State"),Tango_DEV_VOID,Tango_DEV_STATE,new String("Device state")));
		command_list.addElement(new InitCmd(new String("Init"),Tango_DEV_VOID,Tango_DEV_VOID));
...
//
				...
				DbDatum res_value = db_class.get_property(new String("doc_url"));	
...
//
				...
				if (cmd.is_allowed(device,in_any) == false)
				{
					...
					Except.throw_exception("API_CommandNotAllowed",
							     new String(o),
							     new String("DeviceClass.command_handler"));
				}
