...
//-======================================================================
/*
 * TangoArchiveEvent.java
 *
 * Created on September 26, 2003, 12:01 PM
 */
 ...
 */
public class TangoArchiveEvent  extends EventObject implements java.io.Serializable {
    
    /** Creates a new instance of TangoOnAlarmEvent */
    public TangoArchiveEvent(TangoArchive source, EventData event_data)
	{
		super(source);
