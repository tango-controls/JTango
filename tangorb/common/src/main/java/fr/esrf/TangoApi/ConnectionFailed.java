 ...
 *	Exception thrown in case of connection failed.<Br>
 *	Can be instancied by <i>Except.throw_connection_failed</i> method.
 *
...
public class ConnectionFailed extends DevFailed implements ApiDefs
{
	//===================================================================
	/**
	 ...
	 */
	//===================================================================
	public ConnectionFailed(fr.esrf.Tango.DevError[] errors)
	{
		super(errors);
	}
	...
	{
		return"fr.esrf.TangoApi.ConnectionFailed";
	}
	...
	{
		StringBuffer	sb =
			new StringBuffer("fr.esrf.TangoApi.ConnectionFailed:\n");
