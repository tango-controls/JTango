 ...
 *	Exception thrown in case of non valid data..<Br>
 *	Can be instancied by <i>Except.throw_wrong_data_exception</i> method.
 *
...
public class WrongData extends DevFailed implements ApiDefs
{
	 ...
	 */
	//===================================================================
	public WrongData(fr.esrf.Tango.DevError[] errors)
	{
		super(errors);
	}
	...
	{
		StringBuffer	sb =
			new StringBuffer("fr.esrf.TangoApi.WrongData:\n");
