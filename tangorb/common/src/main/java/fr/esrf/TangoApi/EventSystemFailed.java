 ...
 *	Exception thrown in case of event failed.<Br>
 *	Can be instancied by <i>Except.throw_event_system_failed</i> method.
 *
...
public class EventSystemFailed extends DevFailed implements ApiDefs
{
	//===================================================================
	/**
	 ...
	 */
	//===================================================================
	public EventSystemFailed(fr.esrf.Tango.DevError[] errors)
	{
		super(errors);
	}
	...
	{
		return"fr.esrf.TangoApi.EventSystemFailed";
	}
	...
	{
		StringBuffer	sb =
			new StringBuffer("fr.esrf.TangoApi.EventSystemFailed:\n");
