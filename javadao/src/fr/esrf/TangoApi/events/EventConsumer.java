...
//
// $Log$
// Revision 1.24  2010/03/15 13:10:18  pascal_verdier
// Pb on reconnect at first connection (notifd and server re-started) fixed.
//
// Revision 1.23  2010/03/12 14:52:04  pascal_verdier
// idem.
//
// Revision 1.22  2010/03/12 14:50:48  pascal_verdier
// Bug in re-connection in case of external IOR info (Astor usage) fixed.
//
// Revision 1.21  2009/03/25 13:31:04  pascal_verdier
...
public class EventConsumer
    ...
    private ORB orb;
    protected Hashtable<String, EventChannelStruct> channel_map = new Hashtable<String, EventChannelStruct>();
    protected Hashtable<String, String> device_channel_map = new Hashtable<String, String>();
    protected Hashtable<String, EventCallBackStruct> event_callback_map = new Hashtable<String, EventCallBackStruct>();
    protected Hashtable<String, EventCallBackStruct> failed_event_callback_map = new Hashtable<String, EventCallBackStruct>();
    ...
    public int subscribe_event(DeviceProxy device,
        ...
        EventCallBackStruct failed_struct =
                failed_event_callback_map.get(callback_key);
    ...
    public void connect(DeviceProxy device_proxy) throws DevFailed {
        ...
        EventChannelStruct eventChannelStruct = channel_map.get(channel_name);
     ...
     * @param reconnect     manage reconnection if true
                ...
                if (heartbeat_skipped || event_channel_struct.heartbeat_skipped ||
                    ...
                    try {
                        ...
                        try {
                            ...
                            System.err.println("API recieved a DevFailed :	" + e.errors[0].desc);
                        }
                    }
