...
import org.tango.server.device.InitImpl.IInitFinished;
...
public final class DeviceImpl extends Device_4POA {
    ...
    /**
     * Recreating a device does not delete locking object. So maintain a reference
     */
	...
	try {
	    ...
	    final DevicePropertyImpl property3 = new DevicePropertyImpl("min_poll_period", "min poll value", this
		    .getClass().getMethod("setMinPolling", int.class), this, name, className, "0");
	    ...
	    final DevicePropertyImpl property4 = new DevicePropertyImpl("attr_min_poll_period",
		    "min poll value for attributes", this.getClass()
			    .getMethod("setMinAttributePolling", String[].class), this, name, className);
	    ...
	    final DevicePropertyImpl property7 = new DevicePropertyImpl(POLLED_ATTR, "poll attributes", this.getClass()
		    .getMethod("setPolledAttributes", String[].class), this, name, className);
    ...
    private class InitFinishedHandler implements IInitFinished {

	@Override
	public void initDone() throws DevFailed {
	...
	private void configurePolling(final CommandImpl command) throws DevFailed {
		...
		if (command.getName().equals(DeviceImpl.STATE_NAME) || command.getName().equals(DeviceImpl.STATUS_NAME)) {
		    ...
		    final AttributeImpl attribute = AttributeGetterSetter
			    .getAttribute(command.getName(), attributeList);
		    // attribute.updatePollingConfigFromDB();
    ...
    /**
     * Stops polling calls delete method {@link Delete}. Called before init and at server shutdown
     * 
     * @throws DevFailed
     */
	...
	try {
		...
		// with CORBA, the stack trace is not visible by the client if not inserted in DevFailed.
		DevFailedUtils.throwDevFailed(e);
	    }
	}
	return result;
