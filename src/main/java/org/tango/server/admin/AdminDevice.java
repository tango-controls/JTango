...
public final class AdminDevice {
	...
	// logger.debug("init admin device with quartzThreadsPoolSize = {}", quartzThreadsPoolSize);
     ...
     * 
     * @param dvlsa
     *            Lg[0]=Upd period. Str[0]=Device name. Str[1]=Object type(COMMAND or ATTRIBUTE). Str[2]=Object name
     * @throws DevFailed
     */
    ...
    public DevVarLongStringArray zmqEventSubscriptionChange(final String[] argin) {
	return null;
	// TODO EventSubscriptionChange
    }
