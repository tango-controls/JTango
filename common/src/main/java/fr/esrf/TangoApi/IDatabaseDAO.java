...
public interface IDatabaseDAO extends IConnectionDAO {
     ...
     */
    //==========================================================================
    public abstract void export_device(Database database, DeviceExportInfo deviceExportInfo)
            throws DevFailed;
     ...
     */
    //==========================================================================
    public abstract void export_server(Database database, DeviceExportInfo[] deviceExportInfos)
            throws DevFailed;
